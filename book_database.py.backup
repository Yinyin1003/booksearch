...
class BookDatabase:
    def __init__(self):
        ...
        self.books = {
            ...
            "thinking with type": {
                "position": (0.5189, 0.7318, 0.0298, 0.1972),
                "shelf": 1,
                "full_name": "thinking with type A CRITICAL GUIDE"
            },
            "brand bible": {
                "position": (0.5893, 0.7124, 0.0456, 0.2195),
                "points": [(0.5119, 0.6332), (0.5337, 0.6355), (0.5159, 0.8296), (0.5040, 0.8304)],
                "shelf": 1,

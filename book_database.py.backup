...
class BookDatabase:
    def __init__(self):
        ...
        self.books = {
            ...
            "presentationzen": {
                "position": (0.5923, 0.3657, 0.0198, 0.2188),
                "points": [(0.5536, 0.2519), (0.5536, 0.4773), (0.5804, 0.4788), (0.5883, 0.2526)],
                "shelf": 0,
            ...
            "life 3.0": {
                "position": (0.7068, 0.3653, 0.0427, 0.2121),
                "shelf": 0,
                "full_name": "LIFE 3.0: BEING HUMAN IN THE AGE OF ARTIFICIAL INTELLIGENCE"
            },
            "iterate": {
                "position": (0.7346, 0.3650, 0.0486, 0.2247),
                "points": [(0.6815, 0.4728), (0.7024, 0.4714), (0.6786, 0.2571), (0.6567, 0.2556)],
                "shelf": 0,
                "full_name": "ITERATE"
            },
            "rules of play": {
            ...
            "code as creative medium": {
                "position": (0.2700, 0.6500, 0.1200, 0.1200),
                "shelf": 1,
                "full_name": "Code as Creative Medium"
            },
            "graphic design rants and raves": {
                "position": (0.3900, 0.6500, 0.1200, 0.1200),
                "shelf": 1,
                "full_name": "HELLER GRAPHIC DESIGN RANTS AND RAVES"
            },
            "teaching graphic design": {
                "position": (0.5100, 0.6500, 0.1200, 0.1200),
                "shelf": 1,
                "full_name": "TEACHING GRAPHIC DESIGN"
            },
            "thinking with type": {
                "position": (0.6300, 0.6500, 0.1200, 0.1200),
                "shelf": 1,
                "full_name": "thinking with type A CRITICAL GUIDE"
            },
            "brand bible": {
                "position": (0.5883, 0.7173, 0.0516, 0.2195),
                "points": [(0.5625, 0.8270), (0.5823, 0.8263), (0.6141, 0.6075), (0.5923, 0.6083)],
                "shelf": 1,
                "full_name": "BRAND BIBLE"
            },
            "branded interactions": {
                "position": (0.6225, 0.7020, 0.0744, 0.2344),
                "points": [(0.6190, 0.5856), (0.6597, 0.5848), (0.6240, 0.8192), (0.5853, 0.8185)],
                "shelf": 1,
            ...
            "typography 34": {
                "position": (0.3400, 0.6500, 0.1200, 0.1200),
                "shelf": 1,
                "full_name": "TYPOGRAPHY 34"
            },
            "guerrilla advertising": {
                "position": (0.4600, 0.6500, 0.1200, 0.1200),
                "shelf": 1,
